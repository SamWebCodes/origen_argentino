...
<footer class="site-footer">
	...
	<div class="site-footer-col site-footer-col-logo">
		<a href="index.php" class="site-footer-logo" aria-label="<?= esc(oa_setting('home_aria_label')) ?>">
			<img src="<?= esc(oa_media_url('logo_compact')) ?>" alt="<?= esc((string) oa_media('logo_compact')['alt_text']) ?>" width="48" height="58" loading="lazy">
		</a>
	</div>

	<div class="site-footer-col site-footer-col-datos">
		<a class="boton-subir anima anima-rebote" href="#header" aria-label="<?= esc(oa_setting('footer_back_to_top_label')) ?>">
		...
		<img class="site-footer-linea" src="<?= esc(oa_media_url('footer_divider_address')) ?>" alt="" width="400" height="11" loading="lazy">
	</div>
	...
	<div class="site-footer-col site-footer-col-tel">
		...
		<img class="site-footer-linea" src="<?= esc(oa_media_url('footer_divider_phone')) ?>" alt="" width="300" height="8" loading="lazy">
	</div>
...
<div class="widget-contacto">
	...
	<div class="widget-contacto-canales" id="canales-contacto" inert>
		<a class="widget-contacto-canal" href="<?= esc(SITIO_TELEFONO_LINK) ?>">
			<span class="widget-contacto-etiqueta"><?= esc(oa_setting('widget_phone_label')) ?></span>
			...
			<span class="visually-hidden"><?= esc(oa_setting('widget_phone_sr_label')) ?></span>
		</a>

		<a class="widget-contacto-canal" href="mailto:<?= esc(SITIO_EMAIL) ?>">
			<span class="widget-contacto-etiqueta"><?= esc(oa_setting('widget_email_label')) ?></span>
			<svg aria-hidden="true" viewBox="0 0 39 39" xmlns="http://www.w3.org/2000/svg">
			...
			<span class="visually-hidden"><?= esc(oa_setting('widget_email_sr_label')) ?></span>
		</a>

		<a class="widget-contacto-canal" href="<?= esc(SITIO_MAPS_WIDGET_LINK) ?>" target="_blank" rel="noopener">
			<span class="widget-contacto-etiqueta"><?= esc(oa_setting('widget_maps_label')) ?></span>
			<svg aria-hidden="true" viewBox="0 0 39 39" xmlns="http://www.w3.org/2000/svg">
			...
			<span class="visually-hidden"><?= esc(oa_setting('widget_maps_sr_label')) ?></span>
		</a>
	</div>

	<div class="widget-contacto-base">
		<span class="widget-contacto-cta"><?= esc(oa_setting('widget_cta_label')) ?></span>
		<button class="widget-contacto-boton" type="button" aria-expanded="false" aria-controls="canales-contacto" aria-label="<?= esc(oa_setting('widget_open_label')) ?>" data-label-open="<?= esc(oa_setting('widget_open_label')) ?>" data-label-close="<?= esc(oa_setting('widget_close_label')) ?>">
